...
const initialState = {
    ...
    experienceInfo: [
        ...
        { title: 'OSF Academy', time: '2 months', link: 'https://andrian-kars.github.io/HTML-Coding/osf-academy', description: 'When I was attending a course at OSF Academy, I finished this project. It was my final project. I completed it 10 days earlier and better than others. In the end, I was granted the position in OSF Digital.' },
        { title: 'Other 70+ Projects', time: '1000+ hours', link: 'https://github.com/andrian-kars', description: 'There are many other smaller projects. They are my pet and also from finishing different courses.' },
    ] as Array<AboutType>,
}
